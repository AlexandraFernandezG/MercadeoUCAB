...
@Component({
  selector: 'app-resultados-cliente',
  templateUrl: './resultados-cliente.component.html',
  styleUrls: ['./resultados-cliente.component.css']
})
export class ResultadosClienteComponent implements OnInit {
